...
4. Future formatting requirements must be placed within the choices[].content section of the response instead of modifying the OpenAI response.
5. The choices[].content section must obey the formatting requirements defined by the prompt.
6. If your response cannot be formatted to comply with the OpenAI specification you will instead return an OpenAI compliant response which provides an explanation for why providing an OpenAI compilant response was not possible.
]]
            }
