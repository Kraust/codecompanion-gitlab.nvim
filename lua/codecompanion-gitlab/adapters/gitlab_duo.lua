...
4. The fields in the object should be accurate to the model, response and parameters being used.
5. Each Responses generated by the prompt must be serialized as a JSON strong in the messages field of the choice contained in the choices list
