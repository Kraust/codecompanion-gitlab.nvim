...
2. The fields in the object should be accurate to the model, response and parameters being used.
3. This response must be wrapped in *** Begin Response / *** End Response markers"
4. Responses generated by the prompt should be inserted in the messages field of the objects contained in the choices list
